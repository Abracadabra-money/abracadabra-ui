export default [
  {
    inputs: [
      { internalType: "address", name: "_levelPool", type: "address" },
      { internalType: "address", name: "_levelStake", type: "address" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "_staking", type: "bool" },
      {
        internalType: "contract IRewarder",
        name: "_rewarder",
        type: "address",
  ...
  },
  {
    ...
    name: "levelStake",
    outputs: [
      { internalType: "contract ILevelStake", name: "", type: "address" },
    ],
    stateMutability: "view",
    type: "function",
  },
    ...
    outputs: [
      {
        ...
        internalType: "struct LevelMasterV2.PoolInfo",
        name: "pool",
        type: "tuple",
      },
    ],
