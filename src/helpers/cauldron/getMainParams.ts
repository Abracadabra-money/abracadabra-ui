...
export const getMainParams = async (
  ...
  return marketInfo.map(({ result }: MarketInfoResponse, index: number) => {
    ...
    return {
      ...
      mimLeftToBorrow: BigNumber.from(100000000000000000000000n),
      ...
      userMaxBorrow: BigNumber.from(100000000000000000000000n),
      updatePrice,
      alternativeData: {
        collateralPrice: result.collateralPrice,
        mimLeftToBorrow: 100000000000000000000000n,
        ...
        userMaxBorrow: 100000000000000000000000n,
      },
    };
  });
};
