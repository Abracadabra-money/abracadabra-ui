...
export default {
  ...
  watch: {
    ...
    repayBorrowAmount() {
      if (+this.repayBorrowAmount === 0) this.repayCollateralAmount = 0;
    },
  },
  ...
  methods: {
    ...
    async closePositionHandler() {
      ...
      this.repayCollateralAmount = this.maxRepayCollateralAmount;
